...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'gcs' => [
            'driver' => 'gcs',
            'key_file_path' => env('GOOGLE_CLOUD_KEY_FILE', base_path('C:\xampp\htdocs\easychic2\capstone-project-easychic-1-053844c04834.json')), // optional: /path/to/service-account.json
